...
IMC Prosperity 4 was a fictional space-themed trading competition where we traded planetary products and tried to earn as many XIRECs (currency) as possible.
Even though the assets were made up, the trading problems were realistic. We had to deal with:
market making, bid-ask spreads, fair value, options pricing, implied volatility, delta hedging, mean reversion, trend following, bundle relationships, position limits, sizing, risk control, and overfitting.
For each round, IMC gave us three days of previous market data to research and test on. They also gave us a small back tester tool on their website with only a small slice of the next day, around 10% of Day 4, so we could sanity-check the bot before submission.
For the actual scoring, the trading algorithm was then tested on the hidden full evaluation data for that round. That final hidden test was what decided the real performance metrics.
For the algorithmic challenge, we submitted a Python bot that read market data according to our logic and placed buy/sell orders.
Round 1 started with trading groundwork. 
Round 2 kept the same products but added the Market Access Fee auction. 
Round 3 focused on Velvet Fruit Extract options book, 
Round 4 added trade data of market makers, retail traders and informed traders
Round 5 expanded into 50 different products across 10 bundles.
________________________________________
2. Tools Used
...
Across the last three rounds, my process was:
...
Ash-Coated Osmium	80	Mean reversion
...
________________________________________
3. Round 3: Velvet Fruit Extract Options and Hydrogel Packs
3.1 What the Round Was
...
3.3 Underlying Strategy: Market Making
...
3.4 Options Strategy, Delta Hedging, and the Critical Error
...
3.5 Why 6,000 and 6,500 Mattered
...
3.8 What I Could Have Done Better
...
________________________________________
4. Round 4: Same Products, Better Equation, Extra Trade Data
4.1 What the Round Was
...
4.3 Underlying Strategy: Market Making
...
4.4 Options Strategy: Why Variance Fixed the Model
...
5.3 Candlestick Chart Appendix
...
5.15 What I Could Have Done Better
